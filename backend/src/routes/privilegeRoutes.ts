...
export const PRIVILEGE_DEFINITIONS: PrivilegeDefinition[] = [
  ...
  {
    key: 'nav.production_eos',
    module: 'NAVIGATION',
    action: 'VIEW',
    displayName: 'Production EOS',
    description: 'Access production end-of-shift reports',
    category: 'Quick Navigation',
    sortOrder: 1216,
    defaultRoles: ['OPERATOR', 'SUPERVISOR', 'QA_FOOD_SAFETY', 'QUALITY_CONTROL_MANAGER', 'MAINTENANCE_ENGINEERING', 'SAFETY_SECURITY_MANAGER', 'CI_MANAGER', 'ADMIN'],
  },
  ...
  {
    key: 'nav.admin_production_eos_reference',
    module: 'NAVIGATION',
    action: 'VIEW',
    displayName: 'Production EOS Reference Data',
    description: 'Access hidden production EOS calculation reference data',
    category: 'Organization Management',
    sortOrder: 1315,
    defaultRoles: ['ADMIN'],
  },
