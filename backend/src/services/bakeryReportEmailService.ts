    ...
    try {
      const doc = new PDFDocument({
        ...
        info: {
          ...
          Author: 'DashMet Operations Intelligence',
      ...
      const drawFooter = (pageNum: number, totalPages: number) => {
        ...
        doc.font('Helvetica').fontSize(6.5).fillColor(C.gray)
          .text(`Generated by DashMet Operations Intelligence  |  ${data.organizationName}  |  ${generatedAt}`, MG, fy + 4, { width: PW * 0.7, align: 'left' })
  ...
  <div style="max-width:640px;margin:0 auto;background:#ffffff;">
    ...
    <div style="padding:32px 40px;">
      ...
      <p style="font-size:14px;color:#475569;line-height:1.6;margin:24px 0 0;">
        Best regards,<br/><strong>DashMet Operations Intelligence</strong><br/>
        <span style="font-size:12px;color:#94a3b8;">${data.organizationName} &bull; ${data.facilityName}</span>
      </p>
    </div>
    <div style="background:#f8fafc;border-top:1px solid #e2e8f0;padding:20px 40px;text-align:center;">
      <p style="font-size:11px;color:#94a3b8;margin:0;">This is an automated notification from DashMet Operations Intelligence. Please do not reply to this email.</p>
