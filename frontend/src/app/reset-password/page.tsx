          ...
          <div className="backdrop-blur-xl bg-white/5 rounded-2xl shadow-2xl p-6 sm:p-8 border border-white/10">
            <div className="flex flex-col items-center justify-center py-8">
              <div className="relative mb-6">
                <div className="absolute inset-0 w-16 h-16 rounded-full border-4 border-blue-400/30" />
                <div className="w-16 h-16 rounded-full border-4 border-transparent border-t-blue-400 border-r-blue-400 animate-spin" />
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Hang tight!</h3>
              <p className="text-gray-300 text-center">Verifying reset link...</p>
